...
public class mundial {
    public static void main(String[] args) {
        ...
        // Vector paralelo para federaciones (América dividida en 2: CONMEBOL y
        // CONCACAF)
        String[] federaciones = {
        ...
        while (grupoSeleccionado >= 1 && grupoSeleccionado <= 12) {
            ...
            // Cada grupo de 4 tiene 6 partidos en total: (0vs1, 2vs3), (0vs2, 1vs3), (0vs3,
            // 1vs2)
            int[][] enfrentamientos = {
                    { 0, 1 }, { 2, 3 }, // Jornada 1
                    { 0, 2 }, { 1, 3 }, // Jornada 2
            ...
            for (int i = 0; i < enfrentamientos.length; i++) {
                ...
                System.out.println("\nPartido " + (i + 1) + ": " + equipos[eq1] + " (" + federaciones[eq1] + ") vs "
                        + equipos[eq2] + " (" + federaciones[eq2] + ")");
            ...
            for (int i = 0; i < enfrentamientos.length; i++) {
                int eq1 = inicio + enfrentamientos[i][0];
                int eq2 = inicio + enfrentamientos[i][1];
                System.out.println("Fecha: " + fechasPartidos[i] + " | " + equipos[eq1] + " " + resultadosEq1[i] + " - "
                        + resultadosEq2[i] + " " + equipos[eq2]);
            }
            System.out.println("==========================================================================\n");
